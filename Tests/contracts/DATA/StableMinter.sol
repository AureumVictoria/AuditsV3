...
contract StableMinter is Pausable, ReentrancyGuard {
    ...
    uint256 public miningPerSecond = 2314814814814820; // 200 Tokens per 24h
    ...
    function createNewSTABLE() public whenNotPaused {
        _mintTokens();
    }

    // Create new STABLE Tokens via Proxy.
    ...
    function setMiningPerSecond(uint256 _miningPerSecond) external onlyOwner {
        require(
            _miningPerSecond < 2314814814814820,
    ...
    function UpdateStableCheckContract(bool _stableCheckContract)
        external
        onlyOwner
    {
        stabilityCheck = _stableCheckContract;
    }
}
