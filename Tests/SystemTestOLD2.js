...
describe("AMM Testing", function () {
    ...
    it('Users votes on gauges via proxie => ROUND 2', async function () {
        ...
        console.log("User1 votes on variable gauge proxy with  1000 on vLP1");
        ...
        console.log("User1 votes on variable gauge proxy with  250 on sLP1, 250 on sLP2, 500 on vLP1");
    ...
    it('Users votes on gauges via proxie => ROUND 4', async function () {
        console.log("******************************************************");
        console.log();
    ...
    it('check vote => ROUND 4', async function () {
        console.log("******************************************************");
        console.log();
    ...
    it('Users votes on gauges via proxie => ROUND 5', async function () {
        console.log("******************************************************");
        console.log();
    
        console.log("User1 votes on variable gauge proxy with  1000 on vLP1");
        await veVoteProxy.connect(user1).vote([vLP1.address], [oneThousand]);
        let vote1 = await gaugeFactory.votes(user1.address, sLP1.address);
        let vote2 = await gaugeFactory.votes(user1.address, sLP2.address);
        let vote3 = await gaugeFactory.votes(user1.address, vLP1.address);
        let vote4 = await gaugeFactory.votes(user1.address, vLP2.address);
        ...
        console.log("User1 votes on variable gauge proxy with 250 on sLP1, 250 on vLP1, 500 on vLP2");
        await veVoteProxy.connect(user2).vote([sLP1.address, vLP1.address, vLP2.address], [twoHundredAndFifty, twoHundredAndFifty, fiveHundred]);
    ...
    it('check vote => ROUND 5', async function () {
        console.log("******************************************************");
        console.log();
        ...
        expect((divDec(totalWeight).toFixed(2))).to.be.equal((divDec(expectedVotesTotal).toFixed(2)));
        expect((divDec(totalWeight).toFixed(5))).to.be.equal((divDec(expectedWeightTotal).toFixed(5)));
        expect(divDec(sLP1Weight).toFixed(5)).to.be.equal(divDec(expectedsLP1Total).toFixed(5));
        expect(divDec(sLP2Weight).toFixed(5)).to.be.equal(divDec(expectedsLP2Total).toFixed(5));
        expect(divDec(vLP1Weight).toFixed(5)).to.be.equal(divDec(expectedvLP1Total).toFixed(5));
    ...
    it('Users votes on gauges via proxie => ROUND 6', async function () {
        console.log("******************************************************");
        console.log();
    ...
    it('check vote => ROUND 6', async function () {
        console.log("******************************************************");
        console.log();
    ...
    it('Users votes on gauges via proxie => ROUND 7', async function () {
        console.log("******************************************************");
        console.log();
    ...
    it('check vote => ROUND 7', async function () {
        console.log("******************************************************");
        console.log();
    ...
    it('Users votes on gauges via proxie => ROUND 8', async function () {
        console.log("******************************************************");
        console.log();
    
        console.log("User1 votes on variable gauge proxy with 250 on sLP1, 250 on sLP2");
        await veVoteProxy.connect(user1).vote([sLP1.address, sLP2.address], [fiveHundred, fiveHundred]);
        let vote1 = await gaugeFactory.votes(user1.address, sLP1.address);
        let vote2 = await gaugeFactory.votes(user1.address, sLP2.address);
        let vote3 = await gaugeFactory.votes(user1.address, vLP1.address);
        let vote4 = await gaugeFactory.votes(user1.address, vLP2.address);
    ...
    it('check vote => ROUND 8', async function () {
        console.log("******************************************************");
        console.log();
    ...
    it('Users votes on gauges via proxie => ROUND 9', async function () {
        console.log("******************************************************");
        console.log();
    
        console.log("User1 votes on variable gauge proxy with  250 on sLP2, 500 on vLP1, 250 on vLP2");
        await veVoteProxy.connect(user1).vote([sLP2.address, vLP1.address, vLP2.address], [twoHundredAndFifty, fiveHundred, twoHundredAndFifty]);
        let vote1 = await gaugeFactory.votes(user1.address, sLP1.address);
        let vote2 = await gaugeFactory.votes(user1.address, sLP2.address);
        let vote3 = await gaugeFactory.votes(user1.address, vLP1.address);
        let vote4 = await gaugeFactory.votes(user1.address, vLP2.address);
        ...
        console.log("User1 votes on variable gauge proxy with  500 on vLP1, 250 on vLP2, 250 on sLP2");
        await veVoteProxy.connect(user2).vote([vLP1.address, vLP2.address, sLP2.address], [fiveHundred, twoHundredAndFifty, twoHundredAndFifty]);
        let vote5 = await gaugeFactory.votes(user2.address, sLP1.address);
        let vote6 = await gaugeFactory.votes(user2.address, sLP2.address);
        let vote7 = await gaugeFactory.votes(user2.address, vLP1.address);
        let vote8 = await gaugeFactory.votes(user2.address, vLP2.address);
        ...
        console.log("User1 votes on variable gauge proxy with  250 on sLP1, 500 on sLP2, 250 on vLP1");
        await veVoteProxy.connect(user3).vote([sLP1.address, sLP2.address, vLP1.address], [twoHundredAndFifty, fiveHundred, twoHundredAndFifty]);
        let vote9 = await gaugeFactory.votes(user3.address, sLP1.address);
        let vote10 = await gaugeFactory.votes(user3.address, sLP2.address);
        let vote11 = await gaugeFactory.votes(user3.address, vLP1.address);
        let vote12 = await gaugeFactory.votes(user3.address, vLP2.address);
    ...
    it('check vote => ROUND 9', async function () {
        console.log("******************************************************");
        console.log();
    ...
    it('Users votes on gauges via proxie => ROUND 10', async function () {
        console.log("******************************************************");
        console.log();
    ...
    it('check vote => ROUND 10', async function () {
        console.log("******************************************************");
        console.log();
