...
describe("AMM Testing", function () {
    ...
    it('Change fee for variable pairs and update for vLP1', async function () {
        ...
        await pairFactory.setBaseVariableFee(1000000000000);
        ...
        expect(Number(await pairFactory.baseVariableFee())).to.be.equal(Number(1000000000000));
        ...
        await vLP1.connect(user1).setFee(1000000000000);
        ...
        expect(Number(await vLP1.fee())).to.be.equal(Number(1000000000000));
    ...
    it('Change fee for stable pairs and update for sLP1', async function () {
        ...
        await pairFactory.setBaseStableFee(1000000000000);
        console.log('After variable fee updated: ', await pairFactory.baseStableFee());
        expect(Number(await pairFactory.baseStableFee())).to.be.greaterThan(Number(beforeFeeUpdate));
        expect(Number(await pairFactory.baseStableFee())).to.be.equal(Number(1000000000000));
        ...
        await sLP1.connect(user1).setFee(1000000000000);

        const afterFeeUpdatesLP1 = await sLP1.fee();
        console.log('vLP1 After variable fee updated: ', afterFeeUpdatesLP1);

        expect(Number(afterFeeUpdatesLP1)).to.be.greaterThan(Number(beforeFeeUpdatesLP1));
        expect(Number(await sLP1.fee())).to.be.equal(Number(1000000000000));
